...
var dataF = $.request.parameters.get("dataFim");
   ...
   var selectAllP;
    if (dataI === "" || dataF === "") {
        selectAllP =  'select * from \"ANALISE_EFETIVO\".\"HIST_EFETIVO\"' +
                    'where DATA = ( SELECT MAX(DATA) FROM \"ANALISE_EFETIVO\".\"HIST_EFETIVO\")' +
                    'and EMPRESA != \'Nubeliu\'' +
                    'ORDER BY RE ASC';
    }
    else{
          ...
          var resultSet = null;  
                    ...
                    while (resultSet.next()) {  
                            ...
                            /*  var admis = resultSet.getNString(2);
                              ...
                              var adm = ano + "/" + mes + "/" + dia;*/
                              dataPersonal.ADMISSAO =  resultSet.getNString(2);
                              dataPersonal.ALOC = resultSet.getNString(3);
                              dataPersonal.CHAVE = resultSet.getNString(4);
                              dataPersonal.DATA = resultSet.getNString(5); 
                              ...
                              dataPersonal.NP = resultSet.getNString(11);  
